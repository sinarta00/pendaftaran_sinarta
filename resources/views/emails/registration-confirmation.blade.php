...
<head>
    ...
    <title>Konfirmasi Pendaftaran AK3U</title>
</head>
        ...
        <div style="padding: 40px 30px;">
            ...
            <div style="background: linear-gradient(180deg, #f8fafc 0%, #ffffff 100%); padding: 25px; border-radius: 12px; margin-bottom: 30px; border-left: 4px solid #820000;">
                <p style="margin: 0; font-size: 16px; line-height: 1.6; color: #4a5568;">
                    Kami sangat senang Anda memutuskan untuk mengikuti Program Pelatihan AK3U bersama Sinarta MJS. 
                    Berikut adalah informasi Pelatihan yang akan Anda ikuti:
                </p>
            </div>
            ...
            <div style="background: #f8fafc; border-radius: 12px; padding: 25px; margin-bottom: 30px; border: 1px solid #e2e8f0;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="flex: 1; min-width: 250px;">
                        ...
                        <div style="margin-bottom: 16px;">
                            <div style="font-size: 12px; color: #64748b; margin-bottom: 4px; font-weight: 500;">Nomor Telepon</div>
                            <div style="font-weight: 600; font-size: 14px; color: #2c3e50;">{{ $participant->phone }}</div>
                        </div>
                    </div>
                    ...
                    <div style="flex: 1; min-width: 250px;">
                        ...
                        <div style="margin-bottom: 16px;">
                            <div style="font-size: 12px; color: #64748b; margin-bottom: 4px; font-weight: 500;">Jadwal Training</div>
                            <div style="font-weight: 600; font-size: 14px; color: #2c3e50;">{{ $participant->trainingSchedule->name }}</div>
                        </div>
                        <div style="margin-bottom: 16px;">
                            <div style="font-size: 12px; color: #64748b; margin-bottom: 4px; font-weight: 500;">Biaya Training</div>
                            <div style="font-weight: 600; font-size: 14px; color: #2c3e50;">Rp {{ number_format($participant->trainingSchedule->price, 0, ',', '.') }}</div>
                        </div>
                        <div style="margin-bottom: 16px;">
                <div style="font-size: 12px; color: #64748b; margin-bottom: 4px; font-weight: 500;">Hubungi Admin</div>
            ...
            <div style="background: linear-gradient(135deg, #820000 0%, #a02c2c 100%); color: white; border-radius: 12px; padding: 30px; margin-bottom: 30px; text-align: center;">
                ...
                <p style="margin: 0 0 20px 0; font-size: 16px; opacity: 0.9;">
                    Untuk melanjutkan ke tahap Pengumpulan Dokumen Administrasi, silakan melakukan <strong>Down Payment (DP)</strong> sebesar:
                </p>
                ...
                <div style="background: rgba(255, 215, 0, 0.2); border: 2px solid #ffd700; border-radius: 12px; padding: 20px; margin: 20px 0;">
                    ...
                    <div style="font-size: 14px; opacity: 0.8;">
                        sebagai tanda jadi keikutsertaan dalam Program
                    </div>
                </div>
                ...
                <div style="background: rgba(255, 255, 255, 0.15); border-radius: 8px; padding: 15px; margin-top: 20px;">
                    ...
                    <div style="font-size: 20px; font-weight: 600; color: #ffd700;">
                        Rp {{ number_format($participant->trainingSchedule->price - 1000000, 0, ',', '.') }}
                    </div>
                </div>
            </div>
                ...
                <div style="display: flex; align-items: flex-start;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <ul style="margin: 0; color: #0050b3; font-size: 14px; line-height: 1.5; padding-left: 20px;">
                            ...
                            <li>Setelah melakukan pembayaran, Upload Bukti Pembayaran Anda melalui WhatsApp yang tertera di bawah</li>
                            <li>Sertakan <strong>Nomor Registrasi: {{ $participant->registration_number }}</strong> saat konfirmasi</li>
                            <li>Setelah DP dikonfirmasi, Anda akan menerima email dengan link untuk upload dokumen yang diperlukan</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div style="display: flex; align-items: flex-start;">
                    ...
                    <div style="flex: 1;">
                        <p style="margin: 0; color: #9a3412; font-size: 14px; line-height: 1.5;">
                            <strong>Ketentuan:</strong> Dengan melakukan pembayaran, Anda dianggap telah menyetujui dan bersedia apabila terdapat penyesuaian atau perubahan jadwal yang mungkin terjadi sesuai dengan ketentuan dari pihak penyelenggara dan Kemnaker RI.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div style="border-top: 2px solid #e2e8f0; margin: 30px 0; padding-top: 20px;">
                <p style="margin: 0; font-size: 13px; color: #64748b; font-style: italic; text-align: center; line-height: 1.5;">
                    Terima kasih atas kepercayaan Anda karena telah memilih kami sebagai Provider Pelatihan. 
                    Terus tingkatkan Keahlian dan Kompetensi Anda dengan mengikuti Program yang diselenggarakan bersama Sinarta MJS.
                </p>
            </div>
        </div>
